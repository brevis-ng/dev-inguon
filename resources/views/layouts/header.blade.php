            ...
            <li class="md:ml-6 mt-3 md:mt-0">
                <div class="dropdown inline-block relative grid-cols-2">
                    ...
                    <ul class="dropdown-menu absolute hidden pt-4 bg-gray-900 text-sm" id="sub-menu">
                        <li><a href="{{ route('movies.genre', 'phim-hanh-dong') }}">Phim Hành Động</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-khung-bo') }}">Phim Khủng Bố</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-tinh-cam') }}">Phim Tình Cảm</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hoat-hinh') }}">Phim Hoạt Hình</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hai') }}">Phim Hài Hước</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-khoa-hoc-vien-tuong') }}">Phim Viễn Tưởng</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hanh-dong') }}">Phim Cổ Trang</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hanh-dong') }}">Phim Phiêu Lưu</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-kich-tinh') }}">Phim Kịch Tính</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-tai-lieu') }}">Phim Tài Liệu</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-toi-pham') }}">Phim Tội Phạm</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hanh-dong') }}">Phim Ma - Kinh Dị</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-chien-tranh') }}">Phim Chiến Tranh</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hanh-dong') }}">Phim Âm Nhạc</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hanh-dong') }}">Phim Thể Thao</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hanh-dong') }}">Phim Thần Thoại</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hanh-dong') }}">Game show</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hanh-dong') }}">Phim Truyền Hình</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hanh-dong') }}">Phim Chiếu Rạp</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hoat-hinh') }}">Phim Anime</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hanh-dong') }}">Phim Sắp Chiếu</a></li>
                        <li><a href="{{ route('movies.genre', 'phim-hanh-dong') }}">Phim Thuyết Minh</a></li>
                    </ul>
                </div>
            </li>
            <li class="md:ml-6 mt-3 md:mt-0">
