        ...
        <div class="container mx-auto px-4 py-4 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wdrap items-center text-gray-400 text-sm pt-4">
                    ...
                    <span class="ml-1">{!!($movie['vote_average'] + 2311) * 2.17 !!} lượt xem</span>
                    ...
                    <span class="ml-1">{!!($movie['vote_average'] + 231) * 1.23 !!} lượt thích</span>
                </div>
                <div class="entry-data inline-grid grid-cols-2 w-3/5">
                    ...
                    <p class="text-gray-300 mt-4">
                        ...
                        @if (count($movie['actor']) > 0)
                            ...
                            <a href="#" class="hover:text-orange-500">{{ $name }}, </a>
                            @endforeach
                        @endif
                    </p>
                    <p class="text-gray-300 mt-4">
